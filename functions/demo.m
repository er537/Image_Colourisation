...
% Last Modified by GUIDE v2.5 29-Jan-2021 15:32:11
...
elseif strcmp(handles.greyscaleChoice,'Random')
    ...
    axes(handles.colorinfo_axes);
    imshow(handles.colorinfoFig);
elseif strcmp(handles.greyscaleChoice,'Customized')
    axes(handles.colorinfo_axes);
    handles.colorinfoFig = handles.greyscaleFig;
    handles.colorinfoImage = imshow(handles.colorinfoFig);
...
function ImageClickCallback(eventdata, handles,hObject)
    ...
    D = customised_grid(handles.greyscaleFig,coordinates);
    handles.colorinfoFig = partial_recolour(handles.colorinfoFig,handles.originFig,D);
    axes(handles.colorinfo_axes);
    handles.colorinfoImage=imshow(handles.colorinfoFig);
    set(handles.colorinfoImage,'ButtonDownFcn',{@ImageClickCallback,hObject});
    guidata(hObject,handles);
